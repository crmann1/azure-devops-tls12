...
<#
.Synopsis
    Analysis of TLS 1.2 compatibility for Visual Studio.
...
#Endpoint to cipher mapping
$endpointtoCipherMapping = @{
    "status.dev.azure.com" = @("TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
                               "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256", 
                               "TLS_DHE_RSA_WITH_AES_256_GCM_SHA384",
                               "TLS_DHE_RSA_WITH_AES_128_GCM_SHA256")

    "app.vssps.visualstudio.com" = @("TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
                                     "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
                                     "TLS_DHE_RSA_WITH_AES_256_GCM_SHA384",
                                     "TLS_DHE_RSA_WITH_AES_128_GCM_SHA256")

    "go.microsoft.com" = @("TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
                           "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
    ...
    "login.microsoftonline.com" = @("TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
                                    "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
                                    "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384",
                                    "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P256",
                                    "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384",
    ...
    "management.azure.com" = @("TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
                               "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
                               "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384",
                               "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P256",
                               "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384",
    ...
    "graph.windows.net" = @("TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
                            "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
                            "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384",
                            "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P256",
                            "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384",
    ...
    "graph.microsoft.com" = @("TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
                              "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
                              "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384",
                              "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P256",
                              "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384",
    ...
    "management.core.windows.net" = @("TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
                                   "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
                                   "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384",
                                   "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P256",
                                   "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384",
    ...
    "api.vstsusers.visualstudio.com" = @("TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
                                      "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
                                      "TLS_DHE_RSA_WITH_AES_256_GCM_SHA384",
                                      "TLS_DHE_RSA_WITH_AES_128_GCM_SHA256")}

# Cipher to windows version mapping, this should contain one copy of any cipher mentioned above and the min windows version for it.
$ciphertoWindowsVersion = @{
"TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA"           = [version]"10.0"
"TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA_P256"      = [version]"6.1"
"TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA_P384"      = [version]"6.1"
"TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256"        = [version]"10.0"
"TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256"   = [version]"6.1"
"TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P384"   = [version]"6.1"
"TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256"        = [version]"10.0"
"TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384"        = [version]"10.0"
"TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA"           = [version]"10.0"
"TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA_P256"      = [version]"6.1"
"TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA_P384"      = [version]"6.1"
"TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384"        = [version]"10.0"
"TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P256"   = [version]"6.1"
"TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384"   = [version]"6.1"
"TLS_DHE_RSA_WITH_AES_128_GCM_SHA256"          = [version]"6.1"
"TLS_DHE_RSA_WITH_AES_256_GCM_SHA384"          = [version]"6.1"
"TLS_RSA_WITH_3DES_EDE_CBC_SHA"                = [version]"6.1"
"TLS_RSA_WITH_AES_128_CBC_SHA"                 = [version]"6.1"
"TLS_RSA_WITH_AES_128_CBC_SHA256"              = [version]"6.1"
"TLS_RSA_WITH_AES_128_GCM_SHA256"              = [version]"6.1"
"TLS_RSA_WITH_AES_256_CBC_SHA"                 = [version]"6.1"
"TLS_RSA_WITH_AES_256_CBC_SHA256"              = [version]"6.1"
"TLS_RSA_WITH_AES_256_GCM_SHA384"              = [version]"6.1"  }
...
function Main()
{
    Write-Detail "Visual Studio TLS 1.2 Analyzer v.$version"

    $osVersion = GetOSInfo
    Write-Break

    Write-Title "Analysis of TLS 1.2 compatibility: .NET Framework"
    VerifyInstalledNetFramework 
    Write-Break

    Write-Title "Analysis of TLS 1.2 compatibility: OS"
    
    CheckHotFixes $osVersion
    Write-Break

    CheckTLS12Enablement
    Write-Break

    
    Write-Title "Enumerating Machine ciphers"
    $allEnabledciphers = GetAllCiphers

    Write-Title "Probing Sites commonly used by Visual Studio"
    $endpointtoCipherMapping.GetEnumerator() | ForEach-Object {
        $domain = $_.Name
        $ciphersForDomain = $_.Value

        $tls12CiphersForOS = $ciphertoWindowsVersion.Keys | Where-Object { $osVersion -ge $ciphertoWindowsVersion[$_] }
        $serverSupportedCiphersForMachine = $ciphersForDomain | Where-Object { $_ -In $tls12CiphersForOS}
        $OsEnabledCiphersForDomain = $allEnabledciphers | Where-Object { $_ -In $serverSupportedCiphersForMachine }
        Probe $domain $serverSupportedCiphersForMachine $OsEnabledCiphersForDomain
        Write-Host "`n"
    }
    
    PrintGeneralDotNetMitagations
}
...
# Gets all of the TLS 1.2 enabled cipher suites on the machine in the case of win 10 or above. 
# For lower versions of windows this will list all enabled ciphers.
function GetAllCiphers()
{
    ...
    {
        Write-Detail "Running Cipher Suite check (Get-TlsCipherCuite, TLS 1.2 only)..."

        $allenabledResult = Get-TlsCipherSuite
        $allEnabledCipherSuites = $allenabledResult.Name
        ...
        $allEnabledCipherSuites = $tls12EnabledCipherSuites
        $gettlsciphersuiteAnalysisDone = $true
    }

    if (-not $gettlsciphersuiteAnalysisDone)
    {
        Write-Detail "Running Cipher Suite check (BCrypt, all ciphers)..."
        $allEnabledCipherSuites = GetAllCipherSuitesByBCryptAPI
    }

    Write-Detail "All enabled cipher suites:"
    Write-Detail $allEnabledCipherSuites | Out-String
...
function Probe
{
    param ($domain, $serverSupportedCiphers, $localOsEnabledDomainSupportedCiphers)
    ...
    switch ($success)
    {
        ...
        $false 
        {
             ...
             Write-Detail "Server supported ciphers"
             Write-Detail $serverSupportedCiphers | Out-String
        }
    } 
    
    if ($success -eq $false)
    {
        Write-Detail "Matching cipher suites:"
        if ($localOsEnabledDomainSupportedCiphersResult.Count -eq 0) { Write-nonOk  "No matching ciphers available"} else { Write-Detail $localOsEnabledDomainSupportedCiphers | Out-String }
    }

    CheckGroupPolicy $domain $localOsEnabledDomainSupportedCiphers
...
function OutputMitigationToPs1 
{
    ...
    $cmt = "# This PowerShell script was generated as a mitigation by Visual Studio TLS 1.2 readiness checker."
    $lines = @($cmt) + $script
...
{
    param ($domain, $name, $path, $ciphersuiteSegment, $enabledCipherSuites)
    ...
    if ($isExpected)
    {
        Write-Ok "$name key exchange allowed."
    ...
    {    
        ...
        else
        {
            ...
            {    
                Write-nonOK "ISSUE FOUND: No TLS 1.2 cipher suites required by $domain remain enabled after applying $name disablement."
...
{
    param($domain, $requiredEnabledCipherSuites)
    ...
    $keyexchangeFilteredCipherSuites = CheckKeyExchangeEnabled $domain "Diffie-Hellman" "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\KeyExchangeAlgorithms\Diffie-Hellman" "DHE" $requiredEnabledCipherSuites
    if ($osVersion.Major -ge 10) 
    { 
        $keyexchangeFilteredCipherSuites = CheckKeyExchangeEnabled $domain "Elliptic-curve Diffie–Hellman" "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\KeyExchangeAlgorithms\ECDH" "ECDHE" $keyexchangeFilteredCipherSuites
    }
    ...
    RunEllipticCurveCheck $domain $keyexchangeFilteredCipherSuites
}

function RunEllipticCurveCheck
{
    param($domain, $keyexchangeFilteredCipherSuites)
    ...
    else
    {
        ...
        {
            Write-OK "Elliptic curve check passed: at least one elliptic curve supported by $domain is enabled."
        ...
        else
        {
            ...
            $reasonMsg = "All elliptic curves supported by"+ $domain + " are disabled. This makes ECDHE cipher suites unusable for connection."
...
function VerifyInstalledNetFramework()
{
...
function PrintGeneralDotNetMitagations()
{
    Write-Title ".NET TLS Mitigations"
    $mitigations = @()
